...
class Ui_TrainWindow(object):
    def setupUi(self, TrainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("plus.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("minus.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("edit.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
