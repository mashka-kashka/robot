...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/robot_green.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon2.addPixmap(QtGui.QPixmap("icons/robot_red.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
